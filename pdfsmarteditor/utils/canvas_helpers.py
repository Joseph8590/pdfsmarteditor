...
def scale_coordinates(obj: Dict[str, Any], scale_x: float, scale_y: float,
...
def convert_to_pymupdf_annotation(obj: Dict[str, Any], page: fitz.Page) -> Optional[fitz.Annot]:
    """
...
def _convert_freedraw_to_ink(obj: Dict[str, Any], page: fitz.Page) -> Optional[fitz.Annot]:
    ...
    for segment in path:
        if isinstance(segment, list) and len(segment) >= 3:
            ...
            elif cmd == 'Q': # Quadratic curve - just use end point for simplicity or sample
...
def _convert_rect_to_square(obj: Dict[str, Any], page: fitz.Page) -> Optional[fitz.Annot]:
...
def _convert_circle_to_circle(obj: Dict[str, Any], page: fitz.Page) -> Optional[fitz.Annot]:
...
def _convert_text_to_freetext(obj: Dict[str, Any], page: fitz.Page) -> Optional[fitz.Annot]:
...
def _convert_image_to_stamp(obj: Dict[str, Any], page: fitz.Page) -> Optional[fitz.Annot]:
