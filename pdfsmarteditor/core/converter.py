...
class PDFConverter:
        ...
        for page in doc:
            ...
            for img in image_list:
                ...
                for rect in rects:
                    ...
                    try:
                        slide.shapes.add_picture(image_stream, Pt(rect.x0), Pt(rect.y0), width=Pt(rect.width), height=Pt(rect.height))
                    except Exception:
                        continue
    ...
    def scan_to_pdf(self, image_paths: List[str], output_path: str, enhance: bool = True):
        """
