...
def _require_dependency(command: str, friendly_name: str):
    ...
    if not shutil.which(command):
        raise RuntimeError(f"{friendly_name} is required for this operation but '{command}' was not found on PATH.")
...
class PDFManipulator:
    ...
    def split_pdf(self, file_path: str, page_ranges: List[str], output_dir: str) -> List[str]:
        """
    ...
    def add_signature(self, file_path: str, signature_path: str, output_path: str, page_num: int, x: int, y: int, width: int, height: int):
        """
    ...
    def add_watermark(self, file_path: str, text: str, output_path: str, opacity: float = 0.3, rotation: int = 0, font_size: int = 50, color: tuple = (0, 0, 0)):
        """
    ...
    def rotate_pdf(self, file_path: str, output_path: str, rotation: int = 90, page_nums: List[int] = None):
        """
        Rotate PDF pages.
    ...
    def add_page_numbers(self, file_path: str, output_path: str, position: str = "bottom-center"):
        """
