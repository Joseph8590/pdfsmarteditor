...
from api.deps import TEMP_DIR, MAX_UPLOAD_MB
...
def _validate_upload_file(upload_file: UploadFile, allowed_types: Set[str], max_mb: int = MAX_UPLOAD_MB):
...
async def persist_upload_file(upload_file: UploadFile, allowed_types: Set[str], prefix: str = "") -> str:
